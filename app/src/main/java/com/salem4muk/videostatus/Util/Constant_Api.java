...
import com.salem4muk.videostatus.BuildConfig;
...
public class Constant_Api {
    ...
    public static int VIDEO_FILE_SIZE = 15;//set file size
    public static long VIDEO_FILE_DURATION = 30;//set video duration in second
