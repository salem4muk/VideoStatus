...
import com.salem4muk.videostatus.Adapter.MyVideoAdapter;
...
import com.salem4muk.videostatus.Util.EndlessRecyclerViewScrollListener;
...
public class MyVideoFragment extends Fragment {
    ...
    public void getView(Events.MyVideoView myVideoView) {
        if (myVideoAdapter != null) {
            int position = myVideoView.getPosition();
            switch (myVideoView.getType()) {
                case "all":
                    myVideoLists.get(position).setTotal_viewer(myVideoView.getView());
                    myVideoLists.get(position).setTotal_likes(myVideoView.getTotalLike());
                    myVideoLists.get(position).setAlready_like(myVideoView.getAlreadyLike());
                    break;
                case "view":
                    myVideoLists.get(position).setTotal_viewer(myVideoView.getView());
                    break;
