    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (Constant_Api.aboutUsList != null) {
            ...
            String text = "<html><head>"
                    + "<style type=\"text/css\">@font-face {font-family: MyFont;src: url(\"file:///android_asset/fonts/montserrat_alternates_medium.otf\")}body{font-family: MyFont;color: #8b8b8b;}"
                    + "</style></head>"
                    + "<body>"
                    + htmlText
                    + "</body></html>";
